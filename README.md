...
**Optimizations**
Use the script in webpage tests or as DevTools snippet to reproduce the changes.
To do so just copy the [raw content](https://github.com/push-based/observable-hq--audit/blob/main/optimizations.js) and use it.
